...
# merge the size_lim for each column of auc_df that reaches 90%, 95%, 99%, 99.5% and max of the max with train, test, and validation as the column names
...
auc_df_size_lim = pd.concat([auc_df_90_size_lim, auc_df_95_size_lim, auc_df_99_size_lim, auc_df_995_size_lim, auc_df_100_size_lim], ignore_index=True)
# rename the index of auc_df_size_lim
auc_df_size_lim.index = ['90%', '95%', '99%', '99.5%', '100%']
